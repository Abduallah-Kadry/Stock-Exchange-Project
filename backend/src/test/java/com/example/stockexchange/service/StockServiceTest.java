...
class StockServiceTest {
    ...
    void getAllStocks_DescendingSort() {
        // Arrange
        List<Stock> stocks = List.of(stock);
        Page<Stock> stockPage = new PageImpl<>(stocks, PageRequest.of(0, 10), 1);
    ...
    // ==================== getAllStockExchangesByStock Tests ====================

    @Test
    @DisplayName("Should return stock exchanges for valid stock")
    void getAllStockExchangesByStock_Success() {
        // Arrange
    ...
    void getAllStockExchangesByStock_StockNotFound() {
        // Arrange
    ...
    void getAllStockExchangesByStock_NoListings() {
        // Arrange
    ...
    void createStock_DuplicateName() {
        // Arrange
    ...
    void createStock_WithValidPrice() {
        // Arrange
    ...
    @Test
    @DisplayName("Should throw exception when updating non-existent stock price")
    void updatePrice_StockNotFound() {
        // Arrange
    ...
    void deleteStock_WithAffectedExchanges() {
        // Arrange
    ...
    void deleteStock_DuplicateExchanges() {
        // Arrange
        StockListing listing1 = new StockListing();
        listing1.setStockExchange(stockExchange);
        listing1.setStock(stock);
